...
local scheme = wezterm.get_builtin_color_schemes()["XCode Dusk (base16)"]
...
local config = {
	...
	-- font_size = 10.0,
	font = wezterm.font("PowerlineSymbols"),
	font_size = 10,
	-- font_rules = {
	-- 	{
	-- 		italic = true,
    ...
    colors = {
		tab_bar = {
			...
			--new_tab = { bg_color = "black", fg_color = scheme.ansi[8], intensity = "Bold" },
			--new_tab_hover = { bg_color = scheme.ansi[1], fg_color = scheme.brights[8], intensity = "Bold" },
			-- format-tab-title
			--new_background_opacity = 0.pactive_tab = { bg_color = "#000000", fg_color = "#FCE8C3" },
